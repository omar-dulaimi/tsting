...
class About extends Component {
    ...
    render() {
        ...
        <div className="container alt hieght={75} ">
          <div className="row mbr-justify-content-center">
            <div className="col-lg-6 mbr-col-md-10">
              <div className="wrap">
                ...
                <div className="text-wrap center">
                  <h2 className="mbr-fonts-style mbr-bold mbr-section-title3 display-5  myh2"> <span>Successful</span></h2>
            ...
            <div className="col-lg-6 mbr-col-md-10">
              <div className="wrap">
                ...
                <div className="text-wrap center">
                  <h2 className="mbr-fonts-style mbr-bold mbr-section-title3 display-2000"> <span>Our Targets</span></h2>
